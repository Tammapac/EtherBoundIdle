    ...
    <div className="p-4 md:p-6 max-w-5xl mx-auto space-y-4">
      ...
      {!pass.isPremium && (
        <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border-2 border-purple-500/30 rounded-xl p-4 text-center space-y-2">
          ...
          <PixelButton
            variant="ok"
            label={unlockingPremium ? "UNLOCKING..." : `UNLOCK — ${config.premiumCost?.toLocaleString()} GEMS`}
                  ...
                  {tierRewards.free ? (
                    <>
                      ...
                      {reached && !freeClaimed ? (
                        <PixelButton
                          variant="ok"
                          label={claiming === `${tier}-free` ? "..." : "CLAIM"}
                  ...
                  {tierRewards.premium ? (
                    <>
                      ...
                      {reached && pass.isPremium && !premClaimed ? (
                        <PixelButton
                          variant="ok"
                          label={claiming === `${tier}-premium` ? "..." : "CLAIM"}
